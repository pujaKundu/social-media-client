    ...
    <div className="top-0 absolute grid grid-cols-3 gap-4 justify-items-center content-center w-screen py-3 bg-gradient-to-r from-indigo-100 to-fuchsia-100">
      ...
      <div>
        <div className="flex justify-center items-center">
          ...
          <input
            className="w-72 p-3  bg-transparent rounded-full shadow-lg hover:shadow-xl hover:border-purple-400 border border-slate-300"
            type="text"
      ...
      <div className="flex items-center justify-center font-mono ">
        ...
        {/* icons */}
        <div className="flex justify-center items-center text-fuchsia-900">
          <span className="ml-5">
            {/* person */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="bg-slate-600 text-white w-4 h-4 rounded-lg">
          ...
          <p className="bg-slate-600 text-white w-4 h-4 rounded-lg absolute top-5 ml-12 ">
